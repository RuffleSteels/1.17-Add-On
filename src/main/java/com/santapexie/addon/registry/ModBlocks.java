...
public class ModBlocks {
    ...
    public static final TorchTemplate COPPER_SULFATE_TORCH = new TorchTemplate(AbstractBlock.Settings.copy(Blocks.TORCH), AddOnMod.COPPER_SULFATE_PARTICLE);
    public static final WallTorchTemplate COPPER_SULFATE_WALL_TORCH = new WallTorchTemplate(AbstractBlock.Settings.copy(Blocks.WALL_TORCH), AddOnMod.COPPER_SULFATE_PARTICLE);
